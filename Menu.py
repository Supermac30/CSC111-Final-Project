...
class Menu(tk.Frame):
    ...
    def assign_opening(self, value: bool, is_player1: bool):
        """Assign the value of self.with_opening"""
        self.accept_opening.destroy()
        self.decline_opening.destroy()
    ...
    def choose_depth(self, is_player1: bool) -> None:
        ...
        self.title['text'] = "Choose the depth of the Minimax Player (input -1 if the maximum depth is infinite)"
    ...
    def start_game(self) -> None:
        ...
        if self.player1_id == 0:
            ...
            player1 = MonteCarloNeuralNetwork.NeuralNetworkPlayer(
                start_state.copy(),
                neural_network,
                True
            )
        ...
        if self.player2_id == 0:
            ...
            player2 = MonteCarloNeuralNetwork.NeuralNetworkPlayer(
                start_state.copy(),
                neural_network,
                False
            )
        ...
        if self.player1_id == 5:
            history = game.play_with_human(True)[1]
        elif self.player2_id == 5:
            history = game.play_with_human(False)[1]
        else:
            history = game.play_game(True)[1]
